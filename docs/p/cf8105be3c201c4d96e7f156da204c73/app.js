...
function getBubbleTemplate(type, hue, colorHex) {
    ...
    if (type === 'silver') {
        ...
        // 1. 白銀バブルの気品ある光彩（ルミナスグローをプラスして美しく発光）
        const glowGrad = ctx.createRadialGradient(0, 0, drawRadius * 0.65, 0, 0, drawRadius * 1.60);
        glowGrad.addColorStop(0, 'rgba(255, 255, 255, 0.52)');
        glowGrad.addColorStop(0.40, 'rgba(241, 245, 249, 0.28)');
        glowGrad.addColorStop(0.70, 'rgba(226, 232, 240, 0.12)');
